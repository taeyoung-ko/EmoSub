  ...
  function (t, r, i) {
    ...
    function y(t, r) {
      ...
      for (i = 0; i < n; i++)
        "a" == (s = (e = r.lines[i]).pos).type
          ...
          : "b" == s.type &&
            (t.bezierCurveTo(s.x, s.y, s.x2, s.y2, s.x3, s.y3), e.stroke(t, e));
    }
    function d(t, r) {
    ...
    function p(t, r) {
      ...
      "a" != i.type &&
        ("m" == i.type
          ...
          : "l" == i.type
          ? t.lineTo(i.x, i.y)
          : "b" == i.type && t.bezierCurveTo(i.x, i.y, i.x2, i.y2, i.x3, i.y3),
        t.stroke());
    }
    function v(t, r) {
    ...
    function I(t, r, i, e) {
      ...
      "a" == a.type
        ...
        : "l" == a.type
        ? t.lineTo(a.x, a.y)
        : "b" == a.type && t.bezierCurveTo(a.x, a.y, a.x2, a.y2, a.x3, a.y3),
